const IconBack = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="btn-backLogin__svg-Back">
...
const IconShow = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="btn-showPass-svg">
...
export { IconBack, IconText, IconShowConfirm, IconHideConfirm, IconShow, IconHide };